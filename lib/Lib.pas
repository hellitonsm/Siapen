...
function ContemValor(const sCompare, sString: ShortString): Boolean;
...
function MesclarPermissoes(Permissao1, Permissao2, TipoPermissao: string): shortstring;
...
//  DB: TDBClass;
  ...
  PERMISSAO_CONFERE, PERMISSAO_VISITANTE, PERMISSAO_TRABALHO, PERMISSAO_CADASTRO, PERMISSAO_EDUCACAO: shortstring;
  PERMISSAO_PSICOSSOCIAL, PERMISSAO_JURIDICA, PERMISSAO_DISCIPLINA, PERMISSAO_INTELIGENCIA: shortstring;
  PERMISSAO_ENFERMAGEM, PERMISSAO_FARMACIA, PERMISSAO_CLINICAMEDICA, PERMISSAO_PSICOLOGIA, PERMISSAO_PSIQUIATRIA: shortstring;
  PERMISSAO_SAUDE, PERMISSAO_TERAPIAOCUPACIONAL, PERMISSAO_ODONTOLOGIA, PERMISSAO_PEDAGOGIA, PERMISSAO_SERVICOSOCIAL: shortstring;
  PERMISSAO_ARMAS, PERMISSAO_MONITORAMENTO, PERMISSAO_OCORRENCIA, PERMISSAO_CONSELHODISCIPLINAR, PERMISSAO_TRANSFERENCIAINTERNO: shortstring;
  PERMISSAO_MUDANCACELA, PERMISSAO_SAIDAO, PERMISSAO_SAIDAO_CADASTRO, PERMISSAO_CIRCULACAOINTERNO, PERMISSAO_MOVIMENTOSEMIABERTO: shortstring;
  PERMISSAO_FUNCIONARIO, PERMISSAO_FUNCAOFUNCIONARIO, PERMISSAO_UNIDADEPENAL, PERMISSAO_HORARIOFUNCIONARIO: shortstring;
  PERMISSAO_PADRAOSISTEMA, PERMISSAO_EQUIPE, PERMISSAO_LOCALPOSTOTRABALHO, PERMISSAO_AGENTEPOREQUIPE, PERMISSAO_REGRAVISITACAO: shortstring;

  PERMISSAO_PERFILUSUARIO, PERMISSAO_ADVOGADO, PERMISSAO_VISITANTETRAFICO, PERMISSAO_FACCAO, PERMISSAO_CTC, PERMISSAO_CORRESPONDENCIA : shortstring;
  PERMISSAO_AGENDAATENDIMENTO, PERMISSAO_LIVROREVISTA, PERMISSAO_PAVILHAO, PERMISSAO_GALERIA, PERMISSAO_SOLARIO, PERMISSAO_CELA : shortstring;
  PERMISSAO_CONDICAOINTERNO, PERMISSAO_CIDADE, PERMISSAO_RACA, PERMISSAO_ESCOLARIDADE, PERMISSAO_NACIONALIDADE, PERMISSAO_PROCEDENCIA : shortstring;
  PERMISSAO_DESTINO, PERMISSAO_FORNECEDOR, PERMISSAO_PROFISSAO, PERMISSAO_FALTADISCIPLINAR, PERMISSAO_SERIEFASEESTUDO : shortstring;
  PERMISSAO_PROCESSOCONDENACAO, PERMISSAO_DETRACAO, PERMISSAO_INTERRUPCAO, PERMISSAO_REMICAO, PERMISSAO_ARTIGOPENAL : shortstring;
  PERMISSAO_VARAEXECUCAO, PERMISSAO_REMEDIO, PERMISSAO_FUNCAOINTERNO, PERMISSAO_CALCULOTRABALHO, PERMISSAO_REMICAOTRABALHO : shortstring;
  PERMISSAO_ROUPAS, PERMISSAO_GRAUPARENTESCO, PERMISSAO_TIPOCONTATO, PERMISSAO_ASSUNTO, PERMISSAO_SITUACAO, PERMISSAO_SETORTRABALHOCAD : shortstring;
...
var
  ...
  Mensagem: TIdMessage;
  TextoHTML: TIdText;
  ConexaoSegura: TIdSSLIOHandlerSocketOpenSSL;
  Anexo: TIdAttachment;
  I: Integer;
begin
  Result := False;
  ...
  ConexaoSegura := TIdSSLIOHandlerSocketOpenSSL.Create(nil);
...
begin
  ...
  finalc := ShortString(permissaoFinal);
  Result := finalc;
