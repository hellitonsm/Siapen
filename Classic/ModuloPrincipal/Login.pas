...
uses
  ...
  WinSkinStore, WinSkinData, Buttons, ExtCtrls, jpeg;
   ...
   { if (LOGIN_CONECTADO = '99999') then
    ...
    try
      ...
      begin
        ...
        if ((Dsservidor.DataSet.FieldByName('AUTORIZADO_DELPHI').AsString = 'S')
        ...
        begin
          ...
          begin
            ...
            begin
              CreateDir(GLOBAL_PATCH_SISTEMA + '..\Sem Relatório');
        ...
        begin
          if (Dsservidor.DataSet.FieldByName('AUTORIZADO_DELPHI').AsString <> 'S') then
            ShowMessage('Usuário Inativo no Sistema! Entre em contato com o administrador.')
          else
            ShowMessage('Perfil de Usuário Inativo no Sistema! Entre em contato com o administrador.');
            ...
            begin
              ...
              begin
                ...
                PERMISSAO_TRANSFERENCIAINTERNO :=
                  ...
                  Dsservidor.DataSet.FieldByName('PERMISSAO_TRANSFERENCIAINTERNO_').AsString, 'CEDIR');
                ...
                PERMISSAO_MONITORAMENTOEVENTOS :=
                  ...
                  Dsservidor.DataSet.FieldByName('PERMISSAO_MONITORAMENTOEVENTOS_').AsString, 'CEDIR');
