...
type
  TFrmCadastroTipoDieta = class(TFrmModeloCadastro)
    CdsCadastroID_TIPO_DIETA: TIntegerField;
    CdsCadastroTIPO_DIETA: TStringField;
    Label2: TLabel;
...
var
  FrmCadastroTipoDieta: TFrmCadastroTipoDieta;

implementation

{$R *.dfm}

procedure TFrmCadastroTipoDieta.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrmCadastroTipoDieta.DsCadastroDataChange(Sender: TObject;
  Field: TField);
begin
  inherited;
