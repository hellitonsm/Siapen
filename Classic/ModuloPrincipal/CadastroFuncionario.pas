...
type
  TFrmCadastroFuncionario = class(TFrmModeloCadastro)
    ...
    GroupBoxPainel: TGroupBox;
    ChConsultarPainel: TCheckBox;
    ChEditarPainel: TCheckBox;
    ChDeletarPainel: TCheckBox;
    ChInserirPainel: TCheckBox;
    ChRelatorioPainel: TCheckBox;
    ChTodasPainel: TCheckBox;
    ...
    procedure ChConsultarPainelClick(Sender: TObject);
    procedure ChEditarPainelClick(Sender: TObject);
    procedure ChDeletarPainelClick(Sender: TObject);
    procedure ChInserirPainelClick(Sender: TObject);
    procedure ChRelatorioPainelClick(Sender: TObject);
    procedure ChTodasPainelClick(Sender: TObject);
  private
...
begin
  ...
  {  if not DirectoryExists(GLOBAL_PATCH_RELATORIO) then
    begin
      ShowMessage('Não existe a pasta: ' + GLOBAL_PATCH_RELATORIO);
...
begin
  ...
  ChTodasPainel.Checked := False;
  ChEditarPainel.Checked := False;
  ChDeletarPainel.Checked := False;
  ChInserirPainel.Checked := False;
  ChRelatorioPainel.Checked := False;
  ChConsultarPainel.Checked := False;
...
var
  ...
  EVENTOS, SUBEVENTOS, MONITORAMENTOEVENTOS, PAINEL: string;
begin
  ...
  begin
    ...
    PAINEL := dsCadastro.DataSet.FieldByName('PERMISSAO_PAINEL').AsString;
    ...
    ChTodasPainel.Checked := ContemValor('CEDIR', PAINEL);
    ChEditarPainel.Checked := ContemValor('E', PAINEL);
    ChDeletarPainel.Checked := ContemValor('D', PAINEL);
    ChInserirPainel.Checked := ContemValor('I', PAINEL);
    ChRelatorioPainel.Checked := ContemValor('R', PAINEL);
    ChConsultarPainel.Checked := ContemValor('C', PAINEL);
...
begin
  ...
  begin
    ShowMessage('Você não possui permissão para acessar o cadastro de Posto/Local Trabalho!');
  end
  else
  begin
...
begin
  ...
  begin
    ShowMessage('O campo Cargo é obrigatório!');
  ...
  begin
    ShowMessage('O campo "Lotação Atual / Unidade de Acesso ao Sistema" é obrigatório!');
  ...
  begin
    ShowMessage('O campo Perfil de Usuário é obrigatório!');
  ...
  begin
    ShowMessage('As senhas digitadas não conferem!');
...
begin
  ...
  begin
    ShowMessage('O Perfil de Administrador só pode ser concedido por outro Administrador!');
  ...
  begin
    ...
    PAINEL := DsPerfilAtribui.DataSet.FieldByName('PERMISSAO_PAINEL').AsString;
  ...
  ChConsultarPainel.Enabled := not ContemValor('C', PAINEL);
  ChEditarPainel.Enabled := not ContemValor('E', PAINEL);
  ChDeletarPainel.Enabled := not ContemValor('D', PAINEL);
  ChInserirPainel.Enabled := not ContemValor('I', PAINEL);
  ChRelatorioPainel.Enabled := not ContemValor('R', PAINEL);
  ChTodasPainel.Enabled := False;
...
procedure TFrmCadastroFuncionario.ChConsultarPainelClick(Sender: TObject);
begin
  inherited;
  ValidaPermissao(ChConsultarPainel, ChEditarPainel, ChDeletarPainel, ChInserirPainel, ChRelatorioPainel, ChTodasPainel,
    'PERMISSAO_PAINEL');
end;

procedure TFrmCadastroFuncionario.ChEditarPainelClick(Sender: TObject);
begin
  inherited;
  ValidaPermissao(ChConsultarPainel, ChEditarPainel, ChDeletarPainel, ChInserirPainel, ChRelatorioPainel, ChTodasPainel,
    'PERMISSAO_PAINEL');
...
procedure TFrmCadastroFuncionario.ChDeletarPainelClick(Sender: TObject);
begin
  inherited;
  ValidaPermissao(ChConsultarPainel, ChEditarPainel, ChDeletarPainel, ChInserirPainel, ChRelatorioPainel, ChTodasPainel,
    'PERMISSAO_PAINEL');
...
procedure TFrmCadastroFuncionario.ChInserirPainelClick(Sender: TObject);
begin
  inherited;
  ValidaPermissao(ChConsultarPainel, ChEditarPainel, ChDeletarPainel, ChInserirPainel, ChRelatorioPainel, ChTodasPainel,
    'PERMISSAO_PAINEL');
...
procedure TFrmCadastroFuncionario.ChRelatorioPainelClick(Sender: TObject);
begin
  inherited;
  ValidaPermissao(ChConsultarPainel, ChEditarPainel, ChDeletarPainel, ChInserirPainel, ChRelatorioPainel, ChTodasPainel,
    'PERMISSAO_PAINEL');
...
procedure TFrmCadastroFuncionario.ChTodasPainelClick(Sender: TObject);
begin
  inherited;
  ValidaPermissaoTodas(ChConsultarPainel, ChEditarPainel, ChDeletarPainel, ChInserirPainel, ChRelatorioPainel, ChTodasPainel);
end;
