...
//  ExceptionLog,
  ...
  PrincipalArmas in 'PrincipalArmas.pas' {FrmPrincipalArmas},
  Lib in '..\lib\Lib.pas',
  ...
  CadastroArmas in 'CadastroArmas.pas' {FrmCadastroArmas},
  ...
  Municoes in 'Municoes.pas' {FrmMunicoes},
  Espargidores in 'Espargidores.pas' {FrmEspargidores},
  InventarioPatrimonio in 'InventarioPatrimonio.pas' {FrmInventarioPatrimonio},
  MovimentoPatrimonio in 'MovimentoPatrimonio.pas' {FrmMovimentoPatrimonio},
  FinalizarMovimentoPatrimonio in 'FinalizarMovimentoPatrimonio.pas' {FrmFinalizarMovimentoPatrimonio},
  CadastroAcessorio in 'CadastroAcessorio.pas' {FrmCadastroAcessorio};
