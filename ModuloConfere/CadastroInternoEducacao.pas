...
type
  TFrmCadastroInternoEducacao = class(TFrmModeloInterno)
    ...
    Portaria: TLabel;
    SQLPortariaAlunoold: TSQLQuery;
    cdsportariaaluno: TClientDataSet;
    dsportariaaluno: TDataSource;
    dspportariaaluno: TDataSetProvider;
    SQLPortariaAlunooldTURMA: TStringField;
    SQLPortariaAlunooldID_PORTARIA_EDUCACAO: TIntegerField;
    SQLPortariaAlunooldID_INTERNO: TIntegerField;
    SQLPortariaAlunooldDATA_ENTRADA: TSQLTimeStampField;
    SQLPortariaAlunooldID_FUNCIONARIO: TIntegerField;
    SQLPortariaAlunooldOBS: TStringField;
    SQLPortariaAlunooldDATA_FINAL: TSQLTimeStampField;
    SQLPortariaAlunooldPORTARIA: TStringField;
