...
begin
 ...
 ConfigFilePath := TPath.Combine(TPath.GetLibraryPath, 'config.ini');
  ...
  { if not AtivouSkin then
    ...
    showmessage('Skin não carregada');
...
begin
  ...
  begin
    ...
    if Sender is TMenuItem then
      ShowMessage('Não Há Permissão Para Acesso - ' + TMenuItem(Sender)
        .Caption);
...
begin
  ...
  ShowMessage
    ('Os lançamentos de históricos deverão ser feitos através do respectivo módulo do Setor!'
