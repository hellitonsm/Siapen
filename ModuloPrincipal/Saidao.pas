...
procedure TFrmSaidao.NovoClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSaidao.EditprontuarioExit(Sender: TObject);
begin
  inherited;
...
procedure TFrmSaidao.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrmSaidao.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TFrmSaidao.DBGrid1DblClick(Sender: TObject);
var
  cod: integer;
begin
...
procedure TFrmSaidao.SalvarClick(Sender: TObject);
begin
...
procedure TFrmSaidao.SpeedButton1Click(Sender: TObject);
begin
  inherited;
...
procedure TFrmSaidao.Button1Click(Sender: TObject);
var
  interno: variant;
begin
  inherited;
...
procedure TFrmSaidao.BtnincluirClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSaidao.BitBtn2Click(Sender: TObject);
begin
  inherited;

  dm.SqlExecute.sql.Text := 'select id_interno from interno where coalesce(nome_interno,'''')<>'''' and st = ''A'' and id_up = ' + qs(inttostr(global_id_up)) +' order by nome_interno';
...
procedure TFrmSaidao.EditarClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSaidao.CancelarClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSaidao.DsCadastroDataChange(Sender: TObject; Field: TField);
begin
  inherited;
