...
type
  TFrmCadastroDeficiencia = class(TFrmModeloCadastro)
    CdsCadastroID_DEFICIENCIA: TIntegerField;
    CdsCadastroDEFICIENCIA: TStringField;
    Label2: TLabel;
...
var
  FrmCadastroDeficiencia: TFrmCadastroDeficiencia;

implementation

{$R *.dfm}

procedure TFrmCadastroDeficiencia.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrmCadastroDeficiencia.DsCadastroDataChange(Sender: TObject;
  Field: TField);
begin
  inherited;
