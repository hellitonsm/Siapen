            ...
            object TabPrincipal: TTabSheet
              ...
              object DBComboBox2: TDBComboBox
                ...
                Items.Strings = (
                  ...
                  'AGENTE DE ATIVIDADES PENITENCIARIAS'
                  'AUXILIAR DE APOIO AS ATIVIDADES POLICIAIS'
                  'BOMBEIRO MILITAR'
                  'COORDENADOR GERAL DE INCLUSAO, CLASSIFICACAO E REMOCAO'
                  'COORDENADOR GERAL DE INFORMACAO E INTELIGENCIA PENITENCIARIA'
                  'COORDENADOR GERAL DE TRATAMENTO PENITENCIARIO'
                  'DIRETOR DO PRESIDIO'
                  'DIRETOR GERAL DO DEPEN'
                  'DIRETOR EXECUTIVO DO DEPEN'
                  'DIRETOR DO SISTEMA PENITENCIARIO FEDERAL'
                  'DIRETOR DE POLITICAS PENITENCIARIAS'
                  'DELEGADO DE POLICIA CIVIL'
                  'DELEGADO DE POLICIA FEDERAL'
                  'ESPECIALISTA EM ASSISTENCIA PENITENCIARIA'
                  'MOTORISTA'
                  'POLICIAL MILITAR'
                  'POLICIAL CIVIL'
                  'POLICIAL FEDERAL'
                  'T'#201'CNICO PENITENCIARIO'
                  'TECNICO EM ASSISTENCIA PENITENCIARIA'
                  'T'#201'CNICO EM POLITICAS PUBLICAS E GESTAO GOVERNAMENTAL'
              ...
              object DBComboBox1: TDBComboBox
                ...
                Items.Strings = (
                  'ADMINISTRATIVO'
                  'AUXILIAR DE ADJUNTO'
                  'AUXILIAR DE CHEFE DE PLANTAO'
                  'AUXILIAR DO CHEFE DA DIVISAO DE SEGURANCA'
                  'CHEFE DA DIVISAO DE SEGURANCA'
                  'CHEFE DA INTELIGENCIA'
                  'CHEFE DA REABILITACAO'
                  'CHEFE DA SAUDE'
                  'CHEFE DE NUCLEO'
                  'CHEFE DE PATIO'
                  'CHEFE DE PLANTAO'
